...
module.exports = function(config, auth, storage) {
    ...
    app.get('/-/all/:anything?', function(req, res, next) {
        ...
        var stream = storage.search(req.query.startkey || 0, {
            req: req
        });
    ...
    app.put('/-/user/:org_couchdb_user/:_rev?/:revision?', function(req, res, next) {
        var token = req.body.name && req.body.password ? auth.aes_encrypt(req.body.name + ':' + req.body.password).toString('base64') : undefined;
    ...
    // tagging a package
    app.put('/:package/:tag', can('publish'), media('application/json'), tag_package_version);
    app.post('/-/package/:package/dist-tags/:tag', can('publish'), media('application/json'), tag_package_version);
    app.put('/-/package/:package/dist-tags/:tag', can('publish'), media('application/json'), tag_package_version);
    ...
    app.post('/-/package/:package/dist-tags', can('publish'), media('application/json'), expect_json, function(req, res, next) {
    ...
    app.put('/-/package/:package/dist-tags', can('publish'), media('application/json'), expect_json, function(req, res, next) {
    ...
    app.delete('/-/package/:package/dist-tags', can('publish'), media('application/json'), function(req, res, next) {
